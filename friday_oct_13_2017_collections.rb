...
#add key-value pair to each article where the key is 'views' and value = 0
...
@results_array = hash[:response][:results]
#
@results_array.each do |index|
   index[:views] = 0
end
...
# def read_article
# current_view = get_views
#   results_array.each.sample do |index|
#     if index
#       current_view += 1
#     end
#   end
...
#____________________________________________________________
# hash_keys = results_array.each do |index|
#   p index.keys
# end
